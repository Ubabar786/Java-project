...
class B extends T10Marks {
    ...
    public static void main(String[] args) {
        A studentA = new A(97, 89, 81);
        System.out.println("Student A average mark is: " + studentA.getPercentage() + "%");

        B studentB = new B(70, 80, 77, 85);
        System.out.println("Student B average mark is: " + studentB.getPercentage() + "%");
    }
}